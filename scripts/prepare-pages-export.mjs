...
function normalizeHtml(html, route) {
  let next = html
    ...
    .replaceAll('href="/api-reference/boas-vindas"', 'href="/api-reference/services-pessoa-fisica"')
    .replaceAll(`href="${basePath}/api-reference/boas-vindas"`, `href="${basePath}/api-reference/services-pessoa-fisica"`)
...
const apiWelcomeTarget = `${basePath}/api-reference/services-pessoa-fisica/`;
const apiWelcomeRedirect = `<!doctype html><html><head><meta charset="utf-8"><meta http-equiv="refresh" content="0; url=${apiWelcomeTarget}"><link rel="canonical" href="${apiWelcomeTarget}"><script>location.replace(${JSON.stringify(apiWelcomeTarget)});</script></head><body><a href="${apiWelcomeTarget}">Services de pessoa física</a></body></html>`;
