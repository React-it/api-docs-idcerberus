...
function normalizeHtml(html, route) {
  let next = html
    ...
    .replaceAll('href="/api-reference/boas-vindas"', 'href="/api-reference/autorização/gerar-token-de-api"')
    .replaceAll(`href="${basePath}/api-reference/boas-vindas"`, `href="${basePath}/api-reference/autorização/gerar-token-de-api"`)
