...
- **O que é:** um componente (mobile ou web) fornecido pela idCerberus que
...
- **Por que existe:** capturar documento e biometria com qualidade suficiente
...
- **Pra que serve pra você:** sua aplicação não processa imagem nem
...
- Espere alguns segundos entre uma consulta e outra. Não faça polling a cada
...
- Defina um limite de tentativas ou um tempo máximo de espera na sua
...
- `REFUSED` é um resultado final do negócio, não um erro técnico. A chamada em
